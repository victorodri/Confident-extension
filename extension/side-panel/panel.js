...
const translations = {
  es: {
    ...
    sessionCounterRegister: 'Regístrate para 15 totales',
    ...
    // Paywall suave (anónimo 5/5 sesiones)
    paywallSoftTitle: '¡Has usado tus 5 sesiones anónimas! 🎉',
    paywallSoftDesc: 'Confident te ha ayudado en tus conversaciones. Regístrate gratis y obtén 15 sesiones totales.',
    paywallSoftBenefit1: '✓ 15 sesiones gratuitas con registro',
    ...
    // Paywall duro (usuario free 15/15 sesiones)
    paywallHardTitle: 'Has usado tus 15 sesiones gratuitas',
    paywallHardDesc: 'Actualiza a Pro para continuar. Solo €5/mes por 50 sesiones mensuales o €15/mes ilimitado.',
    paywallHardBenefit1: '✓ Pro: 50 sesiones/mes por €5',
    paywallHardBenefit2: '✓ Diamond: Sesiones ilimitadas por €15',
    paywallHardBenefit3: '✓ Análisis IA avanzado + soporte prioritario',
  ...
  en: {
    ...
    sessionCounterRegister: 'Sign up for 15 total',
    ...
    // Soft paywall (anonymous 5/5 sessions)
    paywallSoftTitle: 'You\'ve used your 5 anonymous sessions! 🎉',
    paywallSoftDesc: 'Confident has helped you in your conversations. Sign up for free and get 15 total sessions.',
    paywallSoftBenefit1: '✓ 15 free sessions with sign-up',
    ...
    // Hard paywall (free user 15/15 sessions)
    paywallHardTitle: 'You\'ve used your 15 free sessions',
    paywallHardDesc: 'Upgrade to Pro to continue. Only €5/month for 50 monthly sessions or €15/month unlimited.',
    paywallHardBenefit1: '✓ Pro: 50 sessions/month for €5',
    paywallHardBenefit2: '✓ Diamond: Unlimited sessions for €15',
    paywallHardBenefit3: '✓ Advanced AI analysis + priority support',
